...
//        练习内容：使用各种 Canvas.drawXXX() 方法画直方图
        ...
        // 第一个高度最低的白色矩形
        mPaint.setColor(Color.WHITE);
        canvas.drawRect(START_X + SPACE_WIDTH, END_Y - 2, START_X + SPACE_WIDTH + RECT_WIDTH, END_Y, mPaint);
        // 循环画出其余矩形，
        ...
        for (int i = 2; i < 8; i++) {
            ...
            mPath.addRect(betweenSpace, height, width, END_Y, Path.Direction.CW);
