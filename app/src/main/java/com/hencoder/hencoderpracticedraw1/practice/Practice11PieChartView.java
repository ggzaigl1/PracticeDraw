...
//        练习内容：使用各种 Canvas.drawXXX() 方法画饼图
        ...
        canvas.drawArc(140, 40, 690, 590, -180, 120, true, mPaint);

        mPaint.setColor(Color.YELLOW);
        canvas.drawArc(190, 90, 690, 590, -60, 55, true, mPaint);

        mPaint.setColor(Color.GREEN);
        canvas.drawArc(180, 92, 690, 592, -5, 3, true, mPaint);

        mPaint.setColor(Color.parseColor("#8A36AD"));
        canvas.drawArc(190, 94, 690, 594, -2, 6, true, mPaint);

        mPaint.setColor(Color.GRAY);
        canvas.drawArc(190, 96, 690, 596, 6, 6, true, mPaint);

        mPaint.setColor(Color.parseColor("#4E9488"));
        canvas.drawArc(190, 98, 690, 598, 14, 66, true, mPaint);

        mPaint.setColor(Color.parseColor("#5194EB"));
        canvas.drawArc(180, 100, 690, 600, 82, 98, true, mPaint);
